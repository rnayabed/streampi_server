...
public class OBSSetSceneConfig extends Application implements Initializable{
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
                        ...
                        for(int i = 0;i<dashboardController.actions.length;i++)
                        {
                            ...
                            if(eachAction[0].equals(dashboardController.selectedActionUniqueID))
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        if(selectedScene.equals(sceneOptionsListView.getItems().get(x).toString()))
                                        {
                                    ...
                                    if(!isFound)
                                    {
                                        Label red = new Label(selectedScene);
        ...
        if(dashboardController.actionConfigType == 2)
        {
            ...
            headingLabel.setText("Modify OBS Studio (Set Scene) Action");
        }
    }
            ...
            protected Void call() {
                try
                {
                    ...
                    if(dashboardController.actionConfigType == 1)
                    {
                        ...
                        oldActions[i][2] = "obs_set_scene";
                        String toWrite = selectedSceneName;
